...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Hawaiian Islands")
saveRDS(basemap, here::here("figures/rds", "state_ocean_depth_basemap_noRelief.rds"))
## save 100m raster
basemap_100m <- basemap +
  geom_raster(
        data = relief_100m,
        inherit.aes = FALSE,
        aes(
...
saveRDS(basemap_100m, here::here("figures/rds", "state_ocean_depth_100m_basemap.rds"))
basemap_200m <- basemap +
  geom_raster(
        data = relief_200m,
        inherit.aes = FALSE,
        aes(
...
saveRDS(basemap_200m, here::here("figures/rds", "state_ocean_depth_200m_basemap.rds"))
```
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Hawaii")
saveRDS(basemap, here::here("figures/rds", "hawaii_ocean_depth_basemap_noRelief.rds"))
## save the 100m relief
basemap_100m <- basemap +
  geom_raster(
        data = relief_100m,
        inherit.aes = FALSE,
...
saveRDS(basemap_100m, here::here("figures/rds", "hawaii_ocean_depth_100m_basemap.rds"))
## save the 200m relief
basemap <- basemap +
  geom_raster(
        data = relief_200m,
        inherit.aes = FALSE,
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Kauai")
saveRDS(basemap, here::here("figures/rds", "kauai_ocean_depth_basemap_noRelief.rds"))
## save kauai with 100m relief
basemap_100m <- basemap +
  geom_raster(
        data = relief_100m,
        inherit.aes = FALSE,
...
saveRDS(basemap_100m, here::here("figures/rds", "kauai_ocean_depth_100m_basemap.rds"))
## save kauai with 200m relief
basemap_200m <- basemap +
  geom_raster(
        data = relief_200m,
        inherit.aes = FALSE,
...
saveRDS(basemap_200m, here::here("figures/rds", "kauai_ocean_depth_200m_basemap.rds"))
```
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Oahu, Molokai and Maui")
saveRDS(basemap, here::here("figures/rds", "oahu_molokai_maui_ocean_depth_basemap_noRelief.rds"))
basemap_100m <- basemap +
  geom_raster(
        data = relief_100m,
        inherit.aes = FALSE,
