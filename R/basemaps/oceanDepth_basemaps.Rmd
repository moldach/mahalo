...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief = relief, subtitle = "")
...
ggsave(here::here("figures/png/state_ocean_depth_200m.png"), width = 210, height = 297, units = "mm", dev = agg_png())
