...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief = relief, subtitle = "Hawaiian Islands")
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief = relief, subtitle = "Hawaii")
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief = relief, subtitle = "Kauai")
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief = relief, subtitle = "Oahu, Molokai and Maui")
