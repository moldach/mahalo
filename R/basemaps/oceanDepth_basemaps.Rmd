...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief_100m, subtitle = "Hawaii")
saveRDS(basemap_100m, here::here("figures/rds", "hawaii_ocean_depth_100m_basemap.rds"))
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, relief_200m, subtitle = "Hawaii")
