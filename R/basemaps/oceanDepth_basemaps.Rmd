...
saveRDS(basemap, here::here("figures/rds", "state_ocean_depth_100m_basemap_noRelief.rds"))
basemap +
basemap <- basemap +
  geom_raster(
        data = relief,
...
# load the 200m subset raster file
relief <- data.table::fread(here::here("data/relief/200m/", "srgyhii200a.csv"))
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Hawaiian Islands")
saveRDS(basemap, here::here("figures/rds", "state_ocean_depth_200m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
saveRDS(basemap, here::here("figures/rds", "hawaii_ocean_depth_100m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Hawaii")
saveRDS(basemap, here::here("figures/rds", "hawaii_ocean_depth_200m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
saveRDS(basemap, here::here("figures/rds", "kauai_ocean_depth_100m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Kauai")
saveRDS(basemap, here::here("figures/rds", "kauai_ocean_depth_200m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
saveRDS(basemap, here::here("figures/rds", "oahu_molokai_maui_ocean_depth_100m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
...
basemap <- make_depth_map(ocean_geo = ocean_geo, coast_geo = coast_geo, subtitle = "Oahu, Molokai and Maui")
saveRDS(basemap, here::here("figures/rds", "oahu_molokai_maui_ocean_depth_200m_basemap_noRelief.rds"))
basemap <- basemap +
  geom_raster(
        data = relief,
        inherit.aes = FALSE,
